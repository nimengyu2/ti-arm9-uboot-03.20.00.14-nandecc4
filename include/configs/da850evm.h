...
#define PHYS_SDRAM_1_SIZE	(128 << 20) /* SDRAM size 64MB */
...
#undef CONFIG_SYS_NAND_SMALLPAGE
...
#define MTDPARTS_DEFAULT "mtdparts=am1808_nand:128k(u-boot-env),512k(UBL),128k(u-boot),4m@0x200000(kernel),-(rootfs)"
...
#define CONFIG_BOOTARGS		"console=ttyS2,115200n8 root=/dev/mtdblock4 rootfstype=jffs2 vpif_capture.ch0_bufsize=831488 vpif_display.ch2_bufsize=831488"
#define CONFIG_BOOTCOMMAND	"nandecc sw;nand read 0xc0700000 0x200000 0x280000;bootm 0xc0700000"
#define CONFIG_BOOTDELAY	3

#define CONFIG_EXTRA_ENV_SETTINGS \
        "ethaddr=00:01:02:B4:36:56\0" \
	"ipaddr=192.192.192.215\0" \
	"serverip=192.192.192.154\0"
