...
// tary, 2011-08-02
const struct pinmux_config button_pins[] = {
	{ pinmux[11], 8, 7 },	//GP5[8],  USER_LED_2
	{ pinmux[11], 8, 6 },	//GP5[9],  USER_LED_3
        { pinmux[11], 8, 5 },   //GP5[10], USER_MENU
        { pinmux[11], 8, 4 },   //GP5[11], USER_BACK
        { pinmux[11], 8, 3 },   //GP5[12], USER_HOME
	{ pinmux[12], 8, 0 },	//GP5[7],  USER_LED_1
};
...
/******************************************************************************
 * davinci specific command to switch between NAND HW and SW ecc
 *****************************************************************************/
static int do_switch_ecc(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
	extern void davinci_nand_switch_ecc(int32_t hardware);
